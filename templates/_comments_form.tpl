...
{% if user_id or m.config.mod_akismet.anonymous.value|default_if_undefined:1 %}
	{% wire id="comments-form" type="submit" postback={akismet_newcomment id=id} delegate="mod_akismet" %}
